...
4. **If in MAIN SESSION** (direct chat with your human): Also read `MEMORY.md` en `KENNY-NOVA-PROTOCOL.md`
...
## Verkoopplan (3D Configurator)

When the user asks about cold emails, outreach, or "mail opstellen/versturen" for the 3D configurator: read `3d-configurator-verkoop/ACTIE-COLD-EMAIL.md` and follow that workflow (emails per bedrijf, draft, send after confirmation, log, notify; reacties via Gmail pubsub or manual).

### Voorkom "prompt too large" – takenreeks
